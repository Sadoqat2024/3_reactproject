      ...
      <div>
        ...
        from-backgroundColor to-brightColor shadow-[0_3px_10px_rgb(0,0,0,0.2)">
          ...
          <nav className="hidden md:flex flex-row items-center text-lg font-medium gap-8">
            ...
            >
              Home
              <span className="absolute inset-x-0 bottom-0 h-0.5 bg-black transform 
              scale-x-0 origin-left transition-transform group-hover:scale-x-100"></span>
            </Link>
            <Link
              to="menu"
              spy={true}
        ...
        bg-black text-white left-0 top-16 font-semibold text-2xl text-center pt-8 pb-4 
        gap-8 w-full h-fit transition-transform duration-300`}
        >
        <Link
              to="home"
              spy={true}
